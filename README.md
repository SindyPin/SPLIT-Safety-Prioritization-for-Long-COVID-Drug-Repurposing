...
├── data/
│   ├── causal_genes/
│   │   └── 1_Causal_Genes.csv                    # 1,725 driver genes with evidence labels
│   ├── drug_targets/
│   │   └── 2_Drug_Targets.csv                    # 19,172 drugs with target mappings
│   ├── ground_truth/
│   │   └── 3_Ground_Truth.csv                    # PlaNet predictions for counterfactuals
│   └── cohorts/
│       ├── NCT04809974/                          # Cognitive cohort (template)
│       │   ├── enriched_pharmacology.xlsx
│       │   ├── avoid_primary_composite_q10.csv
│       │   ├── avoid_secondary_guard_q20.csv
│       │   ├── avoid_delta_q10.csv
│       │   └── avoid_sensitivity_*.csv
│       └── NCT04880161/                          # Respiratory cohort (sensitivity)
│           ├── enriched_pharmacology.xlsx
│           └── avoid_*.csv
│
├── src/
...
│   │   ├── control_theory.py
│   │   └── differential_causal_effects.py
│   ├── drug_mapping/
│   │   └── target_mapper.py
│   ├── trial_parsing/
...
│   │   ├── planet_interface.py
│   │   ├── ae_scoring.py
│   │   └── composite_ranking.py
│   ├── deprioritization/
│   │   ├── avoid_list_generator.py
│   │   ├── threshold_screening.py
│   │   └── delta_analysis.py
│   └── enrichment/
│       ├── pubchem_enricher.py
│       ├── chembl_enricher.py
│       └── safety_label_parser.py
│
├── notebooks/
│   ├── 01_causal_gene_analysis.ipynb
│   ├── 02_drug_target_mapping.ipynb
│   ├── 03_planet_predictions.ipynb
│   ├── 04_deprioritization_analysis.ipynb
│   └── 05_figure_generation.ipynb
│
├── Figures/
│   ├── Workflow.png                              # Framework overview
│   ├── Fig1_Causal_Gene_Venn.png
│   ├── Fig2_Safety_Coverage_Tradeoff.png
│   ├── Fig3_Counterfactual_Comparison.png
│   ├── Fig4_AE_Heatmap.png
│   ├── Fig5_Avoid_List_Venn.png
│   └── Fig6_Composite_Distribution.png
│
├── manuscript/
│   ├── main.tex
│   ├── methods.tex
│   ├── results.tex
│   └── supplementary/
│       ├── SM1_Causal_Genes.csv
│       ├── SM2_Drug_Targets.csv
│       ├── SM3_AE_Probabilities.csv
│       ├── SM4_NCT04809974_Avoid_Lists.zip
│       ├── SM5_NCT04880161_Avoid_Lists.zip
│       ├── SM6_NCT04809974_Enrichment.xlsx
│       └── SM7_NCT04880161_Enrichment.xlsx
│
└── configs/
